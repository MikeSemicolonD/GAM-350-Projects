...
public abstract class UCNetwork : MonoBehaviour
{
    ...
    virtual public void Update()
    {
        ...
        {
            ServerNetwork.instance.LogText(GetTime() + ": NetTime:" + netTime + " " + messagesProcessed + " network messages proccessed in " + (Time.realtimeSinceStartup - initialTime).ToString() + " seconds" +
                ...
                "\n\t otherMessages: " + otherMessages,true
                );
        }
    }
    ...
    {
        ServerNetwork.instance.LogText("Network debug message: " + aMsg.ReadString());
    ...
    {
        ServerNetwork.instance.LogText("Network verbose debug message: " + aMsg.ReadString());
    ...
    {
        ServerNetwork.instance.LogText("Network warning message: " + aMsg.ReadString());
    ...
    {
        ServerNetwork.instance.LogText("Network error message: " + aMsg.ReadString());
